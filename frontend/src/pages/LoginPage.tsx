...
export default function LoginPage({ onLogin }: Props) {
  ...
  const [error, setError] = useState(searchParams.get('error') === 'oauth' ? 'Google sign-in failed. Please try again.' : '');
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center p-4">
      <SEO title="Sign In — Lineage AI" noIndex />
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-slate-400 mt-1">Sign in to your counselor dashboard</p>
        </div>
        ...
        <div className={`${tw.card} p-8`}>
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white dark:bg-slate-800 px-2 text-gray-400 dark:text-slate-500">or continue with email</span>
            </div>
          </div>
